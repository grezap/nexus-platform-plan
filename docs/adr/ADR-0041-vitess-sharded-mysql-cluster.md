...
3. **Percona Server 8.0 as the mysqld flavor.** Vitess officially supports MySQL 8.0 + Percona Server 8.0; Percona keeps the lab's MySQL story consistent with 0.G.3's PXC (also Percona). vttablet manages the mysqld lifecycle via `mysqlctld`.
