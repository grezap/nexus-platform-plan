...
How Windows guests in the NexusPlatform lab (140 VMs built through Phase 0.P) are licensed. See [ADR-0144](../adr/ADR-0144-windows-licensing.md) for the decision record.
