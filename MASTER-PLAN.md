...
- Full fleet (131 VMs built/cold-rebuild-proven through 0.O; growing with the remaining sharding tier 0.P) well exceeds the host's RAM at max load → requires **environment targeting**:
