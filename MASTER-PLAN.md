...
- Full fleet (105 VMs built/cold-rebuild-proven through 0.I.4; growing with the remaining observability + sharding tiers) well exceeds the host's RAM at max load → requires **environment targeting**:
