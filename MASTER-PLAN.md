...
**Phase 0 total: ~14 weeks** (0.D expanded from a one-week monolith to 5 sub-phases totalling ~3 weeks; net-neutral against the original 1 wk allocation since 0.D.1–0.D.4 are already shipped within the original window — 0.D.5 lands in the remaining slack).
