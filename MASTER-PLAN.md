...
- Full fleet (93 VMs built/cold-rebuild-proven through 0.L.5; growing toward ~100 with observability + sharding tiers) well exceeds the host's RAM at max load → requires **environment targeting**:
