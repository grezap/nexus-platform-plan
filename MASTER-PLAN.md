...
> Data-tier infra repos spun out under Phase 0.G/0.H are tracked in their own phase rows: `nexus-infra-oltp` (0.G.1-0.G.4 + 0.G.7), `nexus-infra-kafka` (0.H), `nexus-infra-analytics` (0.G.5/0.G.6).
