...
- Full fleet (88 VMs built through 0.L.4, growing toward ~100 with observability + sharding tiers) well exceeds the host's RAM at max load → requires **environment targeting**:
